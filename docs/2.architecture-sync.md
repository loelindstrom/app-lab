...
- example app and copy-paste prompt using `AppLab.onDataChange`
...
app-package/source room  -> encrypted app metadata and HTML source
...
- no icon: local-only app
- cloud check: backed up
- cloud spinner: pending/syncing
- crossed cloud: offline/provider unavailable, will retry
- cloud alert: sync needs attention
