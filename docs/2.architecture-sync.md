...
This still treats invite links as sensitive. They contain the Firebase connection metadata, room ids, decrypt secrets, and room
claim tokens needed to join the shared app. The improvement is that a decoded invite no longer contains the owner material needed
to use the project as generic App Lab storage.
